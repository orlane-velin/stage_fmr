...
https://delladata.fr/tutoriel-personnalisez-word-rmarkdown/
...
<center>Annexe 2 <a name="Annexe 2"></a></center>
```{r echo = FALSE, out.width = "60%", fig.align = 'center', fig.cap = "Installatin d'une bouture de *Slylophora sp.* sur son support" }
